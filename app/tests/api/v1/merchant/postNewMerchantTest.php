...
class postNewMerchantTest extends OrbitTestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        DB::statement("INSERT INTO `{$merchant_table}`
                ...
                ('4', '1', 'keefce@localhost.org', 'Ke Ef Ce', 'Chicket Fast Food', 'Jl. Tunjungan 04', 'Komplek B4', 'Lantai 04', '10', 'Surabaya', '62', 'Indonesia', '031-5123456', '031-512344', '2012-04-02 01:01:04', 'blocked', 'merchants/logo/keefce1.png', 'IDR', 'Rp', 'tx1', 'tx2', 'tx3', 'Bukan Jagonya Ayam!', 'yes', 'merchant', NOW(), NULL, NOW(), 1, 'M04', ''),
    ...
    public function testOMIDAlreadyExists_POST_api_v1_merchant_new()
    {
        // Data to be post
        $_POST['user_id'] = 3;
