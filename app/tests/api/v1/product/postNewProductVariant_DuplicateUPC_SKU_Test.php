...
class postNewProductVariant_DuplicateUPC_SKU_Test extends OrbitTestCase
{
    ...
    /**
     * This test should produce an error, since upc 'UPC-001' are belongs to
     * 'Kemeja Mahal' Product.
     *
     * Celana Sangat Murah	Size 27 (1, 1)
     */
    public function testSaveProductNew_newVariant_CelanaMurah_Size27_DuplicateUPC_UPC_001()
    {
        // Object of first "Celana Murah"
        $celanaMurah1 = new stdClass();
        $celanaMurah1->upc = 'UPC-001';
        $celanaMurah1->sku = NULL;
        $celanaMurah1->price = 35000;

        // It containts array of product_attribute_value_id
        $celanaMurah1->attribute_values = [1, NULL, NULL, NULL, NULL];
        ...
        $errorMessage = Lang::get('validation.orbit.exists.product.upc_code', ['upc' => $celanaMurah1->upc]);
    ...
    /**
     * This test should produce an error, since upc 'SKU-001' are belongs to
     * 'Kemeja Mahal' Product.
     *
     * Celana Sangat Murah	Size 27 (1, 1)
     */
    public function testSaveProductNew_newVariant_CelanaMurah_Size27_DuplicateSKU_SKU_001()
    {
        // Object of first "Celana Murah"
        $celanaMurah1 = new stdClass();
        $celanaMurah1->upc = NULL;
        $celanaMurah1->sku = 'SKU-001';
        $celanaMurah1->price = 35000;
        ...
        $response = json_decode($return);
        $errorMessage = Lang::get('validation.orbit.exists.product.sku_code', ['sku' => $celanaMurah1->sku]);
        $this->assertSame(Status::INVALID_ARGUMENT, (int)$response->code);
        $this->assertSame('error', $response->status);
        $this->assertSame($errorMessage, $response->message);
    }
    ...
    /**
     * This test should produce an error, since upc 'UPC-101' are belongs to
     * 'Kemeja Mahal' variant id 1.
     *
     * Celana Sangat Murah	Size 27 (1, 1)
     */
    public function testSaveProductNew_newVariant_CelanaMurah_Size27_DuplicateUPC_UPC_101_OnVariant()
    {
        // Object of first "Celana Murah"
        $celanaMurah1 = new stdClass();
        $celanaMurah1->upc = 'UPC-101';
        $celanaMurah1->sku = NULL;
        $celanaMurah1->price = 35000;
     ...
     * Celana Sangat Murah	Size 27 (1, 1)
     */
    public function testSaveProductNew_newVariant_CelanaMurah_Size27_DuplicateSKU_SKU_101_OnVariant()
    {
        // Object of first "Celana Murah"
        $celanaMurah1 = new stdClass();
        $celanaMurah1->upc = NULL;
        $celanaMurah1->sku = 'SKU-101';
        $celanaMurah1->price = 35000;
