			...
			<div id="search-tool">
			    <div class="row">
				    <div class="col-xs-6 search-tool-col">
				    	...
				    	<a href="{{ url('/customer/coupon?keyword='.Input::get('keyword').'&sort_by=price&sort_mode=asc&couponid='.Input::get('couponid')) }}" id="sort-by-price-up">
				    		<span class="fa-stack">
				    			<i class="fa fa-square fa-stack-2x"></i><i class="fa fa-chevron-up fa-stack-1x sort-chevron"></i>
				    		</span>
				    	</a> 
				    	<a href="{{ url('/customer/coupon?keyword='.Input::get('keyword').'&sort_by=price&sort_mode=desc&couponid='.Input::get('couponid')) }}" id="sort-by-price-down">
				    		<span class="fa-stack">
				    ...
				    <div class="col-xs-5 search-tool-col">
				    	<a href="{{ url('/customer/coupon?keyword='.Input::get('keyword').'&sort_by=product_name&sort_mode=asc&couponid='.Input::get('couponid')) }}" id="sort-by-name-up">
				    		<span class="fa-stack">
				    			<i class="fa fa-square fa-stack-2x"></i><i class="fa fa-chevron-up fa-stack-1x sort-chevron"></i>
				    		</span>
				    	</a> 
				    	<a href="{{ url('/customer/coupon?keyword='.Input::get('keyword').'&sort_by=product_name&sort_mode=desc&couponid='.Input::get('couponid')) }}" id="sort-by-name-down">
				    		<span class="fa-stack">
				    			<i class="fa fa-square fa-stack-2x"></i><i class="fa fa-chevron-down fa-stack-1x sort-chevron"></i>
				    		</span>
				    	</a>
