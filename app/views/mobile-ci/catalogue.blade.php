													...
													<div class="row row-xs-height catalogue-top">
														...
														<div class="col-xs-6 catalogue-detail bg-catalogue col-xs-height">
															<div class="row">
																...
																@if(! empty($product2->product_code))
																<div class="col-xs-12">
																	<h4>{{ $product2->product_code }}</h4>
																</div>
																@endif
																<div class="col-xs-12 price">
																		...
																		<div class="row row-xs-height catalogue-top">
																			...
																			<div class="col-xs-6 catalogue-detail bg-catalogue col-xs-height">
																				<div class="row">
																					...
																					@if(! empty($product3->product_code))
																					<div class="col-xs-12">
																						<h4>{{ $product3->product_code }}</h4>
																					</div>
																					@endif
																					<div class="col-xs-12 price">
																							...
																							<div class="row row-xs-height catalogue-top">
																								...
																								<div class="col-xs-6 catalogue-detail bg-catalogue col-xs-height">
																									<div class="row">
																										...
																										@if(! empty($product4->product_code))
																										<div class="col-xs-12">
																											<h4>{{ $product4->product_code }}</h4>
																										</div>
																										@endif
																										<div class="col-xs-12 price">
																												...
																												<div class="row row-xs-height catalogue-top">
																													...
																													<div class="col-xs-6 catalogue-detail bg-catalogue col-xs-height">
																														<div class="row">
																															...
																															@if(! empty($product5->product_code))
																															<div class="col-xs-12">
																																<h4>{{ $product5->product_code }}</h4>
																															</div>
																															@endif
																															<div class="col-xs-12 price">
